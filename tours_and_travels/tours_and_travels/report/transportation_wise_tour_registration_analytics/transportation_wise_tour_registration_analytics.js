...
frappe.query_reports["Transportation-wise Tour Registration Analytics"] = {
    "filters": [
        {
            "fieldname": "company",
            "label": __("Company"),
        ...
        },
        {
            ...
            "label": __("Show Transport. Package"),
            "fieldtype": "Check"
        },
        {
    ...
    onload: function(report) {
        ...
        report.page.add_inner_button(("Guide-wise Tour Registration Analytics"), function() {
            var filters = report.get_values();
